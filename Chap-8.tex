...
% 若 $p_1=x-\lambda_1$, 则 $m_{\tau}(x)=(x-\lambda_1)^{e_1}p_2^{e_2}\cdots p_m^{e_m}$,\\
% $\forall 0\neq v\in V$, $0=m_{\tau}(v)=(\tau-\lambda_1)^{e_1}p_2^{e_2}\cdots p_m^{e_m}=(\tau-\lambda_1)\left[(\tau-\lambda_1)^{e_1-1}p_2^{e_2}\cdots p_m^{e_m}(v)\right]=0$,\\
% 若 $\left[(\tau-\lambda_1)^{e_1-1}p_2^{e_2}\cdots p_m^{e_m}(v)\right]\neq 0$, 则 $\left[(\tau-\lambda_1)^{e_1-1}p_2^{e_2}\cdots p_m^{e_m}(v)\right]$ 为 $\tau$ 的属于 $\lambda_1$ 的特征向量.
...
\begin{df}[约当标准型]
    ...
    其中 $[\tau(b_1)]_{\mathcal{B}_{ij}'}=[\tau(v_{ij})]_{\mathcal{B}_{ij}'}=[(\tau-\lambda_i+\lambda_i)(v_{ij})]_{\mathcal{B}_{ij}'}=[(\tau-\lambda_i)(v_{ij})+\lambda_i(v_{ij})]_{\mathcal{B}_{ij}'}=\begin{pmatrix}
        ...
        \vdots\\
        0
    \end{pmatrix}$, $[\tau(b_2)]_{\mathcal{B}_{ij}'}=[\tau(\tau-\lambda_i(v_{ij}))]_{\mathcal{B}_{ij}'}=[(\tau-\lambda_i+\lambda_i)((\tau-\lambda_i)(v_{ij}))]_{\mathcal{B}_{ij}'}=[(\tau-\lambda_i)^2(v_{ij})+\lambda_i\tau(v_{ij})]_{\mathcal{B}_{ij}'}=\begin{pmatrix}
        0\\
        \lambda_i\\
        1\\
        0\\
